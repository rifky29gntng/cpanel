...
const telegramBotToken = '7586265920:AAE1TfqUlyZSkFazsBnT4KpRxEUmo6Ix70E';
const adminTelegramId = '8048481751';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'iky' && password === 'iky1') {
    res.json({ success: true, user: { username: 'iky', role: 'admin' } });
  } else {
